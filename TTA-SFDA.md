...
- `...` [Zhu et al., Proc. CVPR 2025] **Revisiting source-free domain adaptation: Insights into representativeness, generalization, and variety** [[PDF]](https://openaccess.thecvf.com/content/CVPR2025/html/Zhu_Revisiting_Source-Free_Domain_Adaptation_Insights_into_Representativeness_Generalization_and_Variety_CVPR_2025_paper.html) [[G-Scholar--]]()

- `DTE` [Liu et al., Proc. CVPR 2025] **Distinguish then exploit: Source-free open set domain adaptation via weight barcode estimation and sparse label assignment**  [[PDF]](https://openaccess.thecvf.com/content/CVPR2025/html/Liu_Distinguish_Then_Exploit_Source-free_Open_Set_Domain_Adaptation_via_Weight_CVPR_2025_paper.html) [[G-Scholar--]]()

- `BN-SFDA` [Deng et al., Proc. AISTATS 2025] **Leveraging frozen batch normalization for co-training in source-free domain adaptation** [[PDF]](https://proceedings.mlr.press/v258/deng25c.html) [[G-Scholar]](https://scholar.google.com/scholar?cluster=16283498704495397599&hl=en) [[CODE]](https://github.com/SJTU-dxw/BN-SFDA)
...
- `LPR` [Yoo et al., IEEE TIP 2024] **Label space-induced pseudo label refinement for multi-source black-box domain adaptation** [[PDF]](https://openreview.net/forum?id=JGTC6WgO4T) [[G-Scholar--]]()

- `FuzHDA` [Li et al., IEEE TFUZZ 2025] **Fuzzy domain adaptation from heterogeneous source teacher models** [[PDF]](https://ieeexplore.ieee.org/abstract/document/10883015/) [[G-Scholar]](https://scholar.google.com/scholar?cluster=9134621624830129177&hl=en)
...
- `CSFADA` [Yang et al., Pattern Recognition 2025] **Continual source-free active domain adaptation for nasopharyngeal carcinoma tumor segmentation across multiple hospitals** [[PDF]](https://www.sciencedirect.com/science/article/pii/S089360802500749X) [[G-Scholar--]]() [[CODE]](https://github.com/YZC-99/CSFADA)
...
- `...` [Guo and Li, Knowledge and Information Systems 2025] **Contrastive prototype source-free adaptation boosted by inherent data structure** [[PDF]](https://link.springer.com/article/10.1007/s10115-025-02385-7) [[G-Scholar]](https://scholar.google.com/scholar?cluster=18039345089244547596&hl=en)

- `...` [Tian and Kang, Knowledge-Based Systems 2025] **Source-free unsupervised domain adaptation through trust-guided partitioning and worst-case aligning** [[PDF]](https://www.sciencedirect.com/science/article/pii/S0950705125005398) [[G-Scholar]](https://scholar.google.com/scholar?cluster=7821272342666946083&hl=en)

- `GUM` [Tian et al., Applied Soft Computing 2025] **Mutual supervision multi-source-free domain adaptation of image classification** [[PDF]](https://www.sciencedirect.com/science/article/pii/S1568494625007902) [[G-Scholar--]]()
...
- `UCL-GVD` [Chen et al., Engineering Applications of Artificial Intelligence 2025] **A novel method for surface defect inspection: Unsupervised continual learning for gradually varying domains** [[PDF]](https://www.sciencedirect.com/science/article/pii/S0952197625011510) [[G-Scholar]](https://scholar.google.com/scholar?cluster=13096139260974692527&hl=en)
...
### 2025
- `UNLOCK` [Cao et al., Proc. ICCV 2025] **Unlocking constraints: Source-free occlusion-aware seamless segmentation** [[PDF]](https://arxiv.org/abs/2506.21198) [[G-Scholar]](https://scholar.google.com/scholar?cluster=8038184879684704891&hl=en) [[CODE]](https://github.com/yihong-97/UNLOCK)

- `SNSA` [Zheng et al., Proc. AAAI 2025] **Supportive negatives spectral augmentation for source-free cross-domain segmentation** [[PDF]](https://ojs.aaai.org/index.php/AAAI/article/view/33148) [[G-Scholar]](https://scholar.google.com/scholar?cluster=10839229723567441919&hl=en)
...
### 2025
- `TITAN` [Ashraf and Bashir, Proc. ICCV 2025] **TITAN: Query-token based domain adaptive adversarial learning** [[PDF]](https://arxiv.org/abs/2506.21484) [[G-Scholar]](https://scholar.google.com/scholar?cluster=15000583166863282480&hl=en)

- `AATS` [Pu et al., Proc. AAAI 2025] **Leveraging anatomical consistency for multi-object detection in ultrasound images via source-free unsupervised domain adaptation** [[PDF]](https://ojs.aaai.org/index.php/AAAI/article/view/32700) [[G-Scholar]](https://scholar.google.com/scholar?cluster=9665551124777937148&hl=en) [[CODE]](https://github.com/xmed-lab/AATS)

- `MGDL` [Tian et al., IEEE TITS 2025] **Multi-level guided discrepancy learning for source-free object detection in hazy conditions** [[PDF]](https://ieeexplore.ieee.org/abstract/document/10972168) [[G-Scholar]](https://scholar.google.com/scholar?cluster=215144541537618765&hl=en)

- `LPLDA` [Kim et al., IEEE Geoscience and Remote Sensing Letters 2025] **Source-free domain adaptation for remote-sensing object detection using low-confidence pseudo labels** [[PDF]](https://ieeexplore.ieee.org/abstract/document/10949131/) [[G-Scholar]](https://scholar.google.com/scholar?cluster=16363855305838126607&hl=en)
...
- `ProSFDA` [Hu et al., Pattern Recognition 2025] **Source-free domain adaptation using prompt learning for medical image segmentation** [[PDF]](https://www.sciencedirect.com/science/article/pii/S0031320325009513) [[G-Scholar--]]() [[CODE]](https://github.com/ShishuaiHu/ProSFDA)

- `MPPL-SFDA` [Zhang et al., Biomedical Signal Processing and Control 2025] **Multicentric prototype and pseudo-labeling based source-free domain adaptation for Alzheimer's disease classification** [[PDF]](https://www.sciencedirect.com/science/article/pii/S1746809424015416) [[G-Scholar]](https://scholar.google.com/scholar?cluster=15201571002467832800&hl=en)
...
- `C2MAL` [Zhou et al., Medical & Biological Engineering & Computing 2025] **C2MAL: Cascaded network-guided class-balanced multi-prototype auxiliary learning for source-free domain adaptive medical image segmentation** [[PDF]](https://link.springer.com/article/10.1007/s11517-025-03287-0) [[G-Scholar]](https://scholar.google.com/scholar?cluster=13976412109320209474&hl=en)

- `RIOG` [Yan et al., IEEE Sensors Journal 2025] **RIOG: Rectify-to-match gradient for source-free domain adaptive medical image segmentation** [[PDF]](https://ieeexplore.ieee.org/abstract/document/10980183) [[G-Scholar]](https://scholar.google.com/scholar?cluster=10452141168785889020&hl=en) [[CODE]](https://github.com/dogeONE-bit/RIOG)

- `DiT-SFDA` [Wang et al., Expert Systems with Applications 2025] **DiT-SFDA: A source-free domain adaptation method for intelligent diagnosis of cardiovascular diseases with limited heart sound samples** [[PDF]](https://ieeexplore.ieee.org/abstract/document/10980183) [[G-Scholar]](https://scholar.google.com/scholar?cluster=14580884301475166651&hl=en)
...
- `OTA` [Li et al.,  Proc. CVPR 2025] **Optimal transport-guided source-free adaptation for face anti-spoofing** [[PDF]](https://arxiv.org/abs/2503.22984) [[G-Scholar]](https://scholar.google.com/scholar?cluster=2180790669821559803&hl=en)
...
- `UOTA` [Min et al., Proc. ICML Workshops 2023] **Unsupervised open-set task adaptation using a vision-language foundation model** [[PDF]](https://openreview.net/forum?id=aXOLXSu2B7) [[G-Scholar]](https://scholar.google.com/scholar?cluster=13820834641056133366&hl=en)
...
- `UEO` [Liang et al., Proc. ICML 2024] **Realistic unsupervised CLIP fine-tuning with universal entropy optimizatio** [[PDF]](https://openreview.net/forum?id=XxCfToC9pJ) [[G-Scholar]](https://scholar.google.com/scholar?cluster=6389971524903108845&hl=en) [[CODE]](https://github.com/tim-learn/UEO)
...
- `...` [Xu et al., arXiv 2025] **Probability distribution alignment and low-rank weight decomposition for source-free domain adaptive brain decoding** [[PDF]](https://arxiv.org/abs/2504.09109) [[G-Scholar]](https://scholar.google.com/scholar?cluster=15957427133202491546&hl=en)

- `...` [Li et al., arXiv 2025] **Revisiting CLIP for SF-OSDA: Unleashing zero-shot potential with adaptive threshold and training-free feature filtering** [[PDF]](https://arxiv.org/abs/2504.14224) [[G-Scholar--]]()
...
- `SFDAF` [Ye et al., Reliability Engineering & System Safety 2025] **Source-free domain adaptation framework for rotating machinery fault diagnosis by reliable self-learning and auxiliary contrastive learning** [[PDF]](https://www.sciencedirect.com/science/article/pii/S0951832025004296) [[G-Scholar]](https://scholar.google.com/scholar?cluster=1139966407145574811&hl=en)

- `DTSF` [Lu et al., Reliability Engineering & System Safety 2025] **Digital twin-driven source-free adaptation diagnosis for rolling element bearing under data privacy** [[PDF]](https://www.sciencedirect.com/science/article/pii/S0951832025006544) [[G-Scholar--]]()
...
- `SDANU` [Jia et al., Measurement Science and Technology 2025] **A novel source-free domain adaptation network for intelligent diagnosis of bearings under unknown faults** [[PDF]](https://iopscience.iop.org/article/10.1088/1361-6501/adc6a6/meta) [[G-Scholar]](https://scholar.google.com/scholar?cluster=9151711305474566114&hl=en)
...
- `CSAD` [Li et al., Mechanical Systems and Signal Processing 2025] **Calibrated source-free adaptation for intelligent diagnosis** [[PDF]](https://www.sciencedirect.com/science/article/pii/S0888327025002833) [[G-Scholar]](https://scholar.google.com/scholar?cluster=2148204833579036904&hl=en)

- `SFUDA-HCS` [Liu et al., Mechanical Systems and Signal Processing 2025] **Source-free universal domain adaptation for compressor component fault diagnosis guided by hybrid clustering strategy** [[PDF]](https://www.sciencedirect.com/science/article/pii/S0888327025004728) [[G-Scholar--]]()
...
- `ISA` [Fan et al., arXiv 2025] **Adapting in-domain few-shot segmentation to new domains without retraining** [[PDF]](https://arxiv.org/abs/2504.21414) [[G-Scholar]](https://scholar.google.com/scholar?cluster=4911420265576809229&hl=en)

- `...` [Wang and Henao, arXiv 2025] **Model recycling framework for multi-source data-free supervised transfer learning** [[PDF]](https://arxiv.org/abs/2508.02039) [[G-Scholar--]]()